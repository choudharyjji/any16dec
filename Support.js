...
<KeyboardAwareScrollView keyboardShouldPersistTaps='always'>
    ...
    <Text style={{fontSize:15,color:'#A9A9A9',fontFamily:'Poppins-Medium',marginLeft:15}}>{this.state.helpline_no}</Text>
    </View>

    <View style={{flexDirection:'row',marginTop:15,marginLeft:8,alignItems:'center'}}>
    <Image source={require('./emaillogo.png')}
          style={{width:35, height:35,resizeMode: 'contain'}} />
    <Text style={{fontSize:15,color:'#A9A9A9',fontFamily:'Poppins-Medium',marginLeft:7}}>{this.state.helpline_email}</Text>
    </View>
