...
export default class ActiveSubscription extends Component {
    constructor(props) {
        super(props);
        this.state = {
            recognized: '',
    ...
    _handleStateChange = (state) => {
        ...
        const url = GLOBAL.BASE_URL + 'user_package'
        ...
        fetch(url, {
            ...
            .then((responseJson) => {
                ...
                if (responseJson.status == true) {
                    ...
                    this.setState({package_detail:responseJson.package_detail})
                    this.setState({add_on_detail:responseJson.add_on_detail})
                    this.setState({user_package_detail:responseJson.user_package_detail})
                } else {
