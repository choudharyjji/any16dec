                    ...
                    <View style = {{flexDirection:'row',width :'100%'}}>
                        ...
                        <View>
                            ...
                            <View style = {{flexDirection:'row',width:'100%'}}>
                                ...
                                <View style = {{backgroundColor:'#F1AE42',borderRadius:4,width:'auto',height:25,marginTop:18,flexDirection:'row',justifyItems:'center',alignItems:'center'}}>
                                    <Image style = {{width :15 ,height :15,marginLeft:4,resizeMode:'contain'}}
                                           source={require('./star.png')}/>

                                    <Text style={{marginLeft : 5,fontSize : 12,marginTop:3,color :'white',fontFamily:'Poppins-Medium',marginRight:5}}>
