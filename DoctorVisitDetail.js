            ...
            <TouchableOpacity onPress={() => this.selectedFirst(index)
                ...
                {item.is_selected == '' && (
                    <View style={{height:60,shadowOpacity: 1.0,justifyContent:'center',alignItems:'center',
                        ...
                        <Text style={{color:'#707070',fontSize:18,textAlign:'center', margin:5}}>
                            {item.time}
                        </Text>
                ...
                {item.is_selected != '' && (
                    <View style={{height:60,shadowOpacity: 1.0,justifyContent:'center',alignItems:'center',
                        ...
                        <Text style={{color:'white',fontSize:18,textAlign:'center', margin:5}}>
                            {item.time}
                        </Text>
        ...
        return (
                ...
                <View style={styles.container}>
                    <KeyboardAwareScrollView>
                        ...
                        fontFamily:'Poppins-Medium',width :window.width - 80}}>
                            Select Address
                        </Text>

                        <Image style={{marginLeft:30, resizeMode:'contain', width:25, height:25, marginTop:10}}
