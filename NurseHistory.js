                    ...
                    {item.booking_type != "Emergency Visit" &&  (
                        <View style={{flexDirection:'row'}}>
                            ...
                            <View style={{flexDirection: 'column', marginTop:15,marginLeft:5,width:'100%'}}>
                                ...
                                <Text style={{color:'#C0C0C0', fontSize:14,fontFamily:'Poppins-Medium',marginTop:8}}>{item.address}</Text>
                                <Text style={{color:'#C0C0C0', fontSize:14,fontFamily:'Poppins-Medium',marginTop:8}}> Date :{item.booking_date}</Text>
                                <Text style={{color:'black', fontSize:14,fontFamily:'Poppins-Medium',marginTop:8}}>Day :{item.days}</Text>
                                <Text style={{color:'black', fontSize:14,fontFamily:'Poppins-Medium',marginTop:8}}>Booking Status :{item.booking_status}</Text>
        ...
        return (
            <View style={styles.container}>
                {this.state.results.length== 0 && (
                 <Text style={{marginTop:'20%',fontSize : 18,color :'black', height:'auto',fontFamily:'Poppins-Regular',alignSelf:'center'}}>
