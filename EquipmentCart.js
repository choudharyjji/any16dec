        ...
        return (
            ...
            <View style={{ flex: 1 ,flexDirection:'row',marginLeft : 5,width:window.width - 10,marginTop: 10,marginBottom:10,borderRadius:10 }}>
                ...
                <Text  style = {{color:'black',fontSize:14,marginLeft:4,marginTop:4,fontFamily:'Poppins-Regular', width:'80%'}}>
                    ...
                    <View style = {{flexDirection:'row',width:100,borderWidth:1,borderColor:'grey',height:30,marginLeft:20,justifyContent:'space-around'}}>
                        ...
                        <Text  style = {{color:'#0592CC',fontSize:14,fontFamily:'Poppins-Regular', marginTop:5}}>
                             {item.quantity}
